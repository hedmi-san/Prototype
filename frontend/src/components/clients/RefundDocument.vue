      ...
      <div v-if="refund" class="a4-sheet printable-doc-target" id="printable-refund-voucher">
        ...
        <div class="details-grid">
          ...
          <div class="detail-box client-box">
            ...
            <div class="box-content">
              <div class="info-line">
                <span class="info-label">Compte Client :</span>
                <span class="info-value font-mono font-bold">{{ refund.clientCode }} — {{ refund.clientName }}</span>
              </div>
              <div v-if="refund.recipientName" class="info-line highlight-beneficiary">
                <span class="info-label">Bénéficiaire (Reçu par) :</span>
                <span class="info-value font-bold text-uppercase text-primary">{{ refund.recipientName }}</span>
              </div>
              <div v-if="refund.recipientPhone" class="info-line">
                <span class="info-label">Tél. Bénéficiaire :</span>
                <span class="info-value font-mono font-bold">{{ refund.recipientPhone }}</span>
              </div>
              <div v-if="refund.recipientIdCard" class="info-line">
                <span class="info-label">N° Pièce Identité :</span>
                <span class="info-value font-mono">{{ refund.recipientIdCard }}</span>
              </div>
              <div v-else-if="refund.clientPhone && !refund.recipientPhone" class="info-line">
          ...
          <div class="detail-box mode-box">
            ...
            <div class="box-content">
              <div v-if="refund.creditNoteNumber" class="info-line">
                <span class="info-label">Avoir Comptoir Lié :</span>
                <span class="info-value font-mono font-bold text-primary">{{ refund.creditNoteNumber }}</span>
              </div>
              <div v-if="refund.saleInvoiceNumber" class="info-line">
                <span class="info-label">Facture d'Origine :</span>
                <span class="info-value font-mono">{{ refund.saleInvoiceNumber }}</span>
              </div>
              <div class="info-line">
              ...
              <div class="info-line">
                ...
                <span class="info-value">Débit Cpt Client (Régularisation avoir)</span>
              </div>
        ...
        <div class="signatures-section">
          ...
          <div class="sig-card client-sig">
            ...
            <div class="sig-footer">
              <span>Signature du bénéficiaire ({{ refund.recipientName || refund.clientName }}) :</span>
            </div>
          </div>
        </div>
