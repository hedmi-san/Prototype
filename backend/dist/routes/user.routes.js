...
router.delete('/:id', authenticate, requireRole('ADMIN'), async (req, res) => {
    ...
    `, [targetId]);
        ...
        await logAudit(req.user, 'USER_DELETED', 'USER', targetId, `Supprimé le compte utilisateur ${existingUser.username} (${existingUser.role_name})`, existingUser.warehouse_id);
