...
export async function seedData() {
    const seedSalesIfEmpty = async (client) => {
        ...
        const salesToInsert = [
            { id: 1, inv: 'INV-20260818-01', wh: 1, u: 2, c: 'SARL Bâtiment Pro Alger', p: '+213 550 12 34 56', total: 56000.0, dt: todayStr, item: { prod: 1, qty: 2, price: 28000.0, sub: 56000.0 } },
            { id: 2, inv: 'INV-20260818-02', wh: 3, u: 4, c: 'Entreprise Travaux Constantine', p: '+213 553 99 88 77', total: 36500.0, dt: todayStr, item: { prod: 3, qty: 1, price: 36500.0, sub: 36500.0 } },
            { id: 3, inv: 'INV-20260817-01', wh: 1, u: 2, c: 'Quincaillerie Centrale El Harrach', p: '+213 551 23 45 67', total: 55500.0, dt: yestStr, item: { prod: 4, qty: 3, price: 18500.0, sub: 55500.0 } },
            { id: 4, inv: 'INV-20260817-02', wh: 2, u: 3, c: 'Chantier Ouest Oran', p: '+213 552 34 56 78', total: 125000.0, dt: yestStr, item: { prod: 5, qty: 1, price: 125000.0, sub: 125000.0 } },
            { id: 5, inv: 'INV-20260815-01', wh: 1, u: 2, c: 'Atelier Outillage Rouiba', p: '+213 550 45 67 89', total: 73000.0, dt: threeDaysStr, item: { prod: 3, qty: 2, price: 36500.0, sub: 73000.0 } },
            { id: 6, inv: 'INV-20260813-01', wh: 2, u: 3, c: 'EURL BTPH Oran Centre', p: '+213 552 67 89 01', total: 49000.0, dt: fiveDaysStr, item: { prod: 2, qty: 2, price: 24500.0, sub: 49000.0 } },
            { id: 7, inv: 'INV-20260718-01', wh: 1, u: 2, c: 'Coopérative Artisanat Alger', p: '+213 550 78 90 12', total: 140000.0, dt: lastMonthStr, item: { prod: 1, qty: 5, price: 28000.0, sub: 140000.0 } },
            { id: 8, inv: 'INV-20260724-01', wh: 3, u: 4, c: 'Mohamed Bennani (Constantine)', p: '+213 540 19 87 11', total: 73000.0, dt: lastMonthStr2, item: { prod: 3, qty: 2, price: 36500.0, sub: 73000.0 } },
            { id: 9, inv: 'INV-20250818-01', wh: 2, u: 3, c: 'Société Générale de Travaux Oran', p: '+213 552 89 01 23', total: 250000.0, dt: lastYearStr, item: { prod: 5, qty: 2, price: 125000.0, sub: 250000.0 } },
        ];
        ...
        RETURNING id
      `, [s.inv, s.wh, s.u, s.c, s.p, s.total, s.dt, s.dt, s.dt]);
