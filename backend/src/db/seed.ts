...
export function seedData(): void {
  ...
  runTransaction(() => {
    ...
    // Algiers Hub
    insertStock.run(1, 1, 25); insertMovement.run(1, 1, 25);
    insertStock.run(1, 2, 30); insertMovement.run(1, 2, 30);
    insertStock.run(1, 3, 15); insertMovement.run(1, 3, 15);
    insertStock.run(1, 4, 40); insertMovement.run(1, 4, 40);
    insertStock.run(1, 5, 8);  insertMovement.run(1, 5, 8);

    // Oran Hub
    insertStock.run(2, 1, 12); insertMovement.run(2, 1, 12);
    insertStock.run(2, 2, 18); insertMovement.run(2, 2, 18);
    insertStock.run(2, 4, 20); insertMovement.run(2, 4, 20);

    // Constantine Hub
    insertStock.run(3, 1, 10); insertMovement.run(3, 1, 10);
    insertStock.run(3, 3, 12); insertMovement.run(3, 3, 12);
