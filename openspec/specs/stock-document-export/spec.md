# stock-document-export Specification

## Purpose
Enables multi-row selection in the stock & inventory table, selective CSV export, and A4 PDF generation (Devis / Sales Price List and Reference Catalog) using a calm contextual action toolbar.
