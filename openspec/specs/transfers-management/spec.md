...
## Purpose
Manages inter-warehouse transfer workflows, source stock reservations, reception confirmations, cancellation lifecycles, and multi-destination inventory bulk relocations.
