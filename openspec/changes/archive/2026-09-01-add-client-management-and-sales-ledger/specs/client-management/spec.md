...
The system SHALL provide a central registry for managing commercial clients with unique codes, contact details, tax numbers, and activity status.

#### Scenario: Registering a new client
- **WHEN** an authorized user creates a new client with a unique code, name, phone, email, address, and optional tax identification (NIF/RC/NIS/ART)
